...
namespace LKengine {
    ...
    IGameScreen* LKengine::ScreenList::moveNext() {
    ...
    IGameScreen* LKengine::ScreenList::movePrevious() {
        IGameScreen* currentScreen = getCurrent();
    ...
    void LKengine::ScreenList::setScreen(int nextScreen) {
        m_currentScreenIndex = nextScreen;
    }

    void LKengine::ScreenList::addScreen(IGameScreen* newScreen) {
    ...
    void LKengine::ScreenList::destroy() {
